...
Feature: Homebanking_Pago_Servicios_Web

Scenario: Flujo Homebanking_Pago_Servicios_Web
  ...
  And selecciona "SRV002" en "Selecciona el Servicio"
  And hace clic en "Monto a Pagar"
  And completa "Monto a Pagar" con "1200"
