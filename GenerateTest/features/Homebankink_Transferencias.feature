...
Feature: Homebankink_Transferencias

Scenario: Flujo Homebankink_Transferencias
  ...
  And completa "Monto" con "1159"
  And hace clic en "Descripción (opcional)"
  And completa "Descripción (opcional)" con "Proyecto Playwright 98%"
  And hace clic en "Transferir"
  And hace clic en "Confirmar"
  And hace clic en "Salir"
  And hace clic en "Confirmar"
  And hace clic en "Sesión cerrada correctamente"
