...
/**
 * Accessibility tests for DemoQA_Elements_Modales
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Modales', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Modales:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Modales`).toBe(0);
