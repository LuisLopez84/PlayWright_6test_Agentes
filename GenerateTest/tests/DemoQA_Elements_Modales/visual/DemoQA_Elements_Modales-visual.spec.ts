...
/**
 * Visual regression test for DemoQA_Elements_Modales
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Modales', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Modales.png', {
      fullPage: true,
