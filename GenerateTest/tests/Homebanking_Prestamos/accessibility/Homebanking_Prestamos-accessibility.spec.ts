...
/**
 * Accessibility tests for Homebanking_Prestamos
 ...
 */
test.describe('Accessibility tests for Homebanking_Prestamos', () => {

  test('axe scan — sin violaciones críticas', async ({ page }) => {
    await smartGoto(page, 'Homebanking_Prestamos');
    ...
    console.log(`♿ Accessibility scan for Homebanking_Prestamos:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebanking_Prestamos`).toBe(0);
