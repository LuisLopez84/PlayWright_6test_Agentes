...
/**
 * Visual regression test for Homebanking_Prestamos
 ...
 */
test.describe('Visual regression for Homebanking_Prestamos', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_Prestamos.png', {
      fullPage: true,
