...
/**
 * Visual regression test for DemoQA_Elements_Widges4
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Widges4', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Widges4.png', {
      fullPage: true,
