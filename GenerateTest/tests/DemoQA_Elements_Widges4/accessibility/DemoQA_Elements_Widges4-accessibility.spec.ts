...
/**
 * Accessibility tests for DemoQA_Elements_Widges4
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Widges4', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Widges4:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Widges4`).toBe(0);
