...
/**
 * Accessibility tests for DemoQA_Elements_Widges8
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Widges8', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Widges8:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Widges8`).toBe(0);
