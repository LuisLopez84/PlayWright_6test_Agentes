...
/**
 * Visual regression test for DemoQA_Elements_Widges8
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Widges8', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Widges8.png', {
      fullPage: true,
