...
/**
 * Accessibility tests for DemoQA_Elements_Buttons
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Buttons', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Buttons:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Buttons`).toBe(0);
