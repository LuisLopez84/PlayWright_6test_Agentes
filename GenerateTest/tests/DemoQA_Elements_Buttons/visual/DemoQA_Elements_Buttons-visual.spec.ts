...
/**
 * Visual regression test for DemoQA_Elements_Buttons
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Buttons', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Buttons.png', {
      fullPage: true,
