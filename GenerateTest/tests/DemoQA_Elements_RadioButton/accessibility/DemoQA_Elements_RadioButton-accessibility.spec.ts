...
/**
 * Accessibility tests for DemoQA_Elements_RadioButton
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_RadioButton', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_RadioButton:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_RadioButton`).toBe(0);
