...
/**
 * Visual regression test for DemoQA_Elements_RadioButton
 ...
 */
test.describe('Visual regression for DemoQA_Elements_RadioButton', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_RadioButton.png', {
      fullPage: true,
