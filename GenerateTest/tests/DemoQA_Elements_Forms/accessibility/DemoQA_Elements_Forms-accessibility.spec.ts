...
/**
 * Accessibility tests for DemoQA_Elements_Forms
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Forms', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Forms:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Forms`).toBe(0);
