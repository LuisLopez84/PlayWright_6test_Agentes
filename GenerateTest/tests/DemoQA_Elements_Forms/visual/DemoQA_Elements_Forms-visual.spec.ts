...
/**
 * Visual regression test for DemoQA_Elements_Forms
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Forms', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Forms.png', {
      fullPage: true,
