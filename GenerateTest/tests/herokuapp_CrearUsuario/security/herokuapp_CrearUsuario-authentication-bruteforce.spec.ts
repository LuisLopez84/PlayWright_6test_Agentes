...
test.describe('Brute force protection for herokuapp_CrearUsuario', () => {
  ...
  test('Protección contra brute force via UI', async ({ page }) => {
    ...
    console.log('ℹ️ Brute force UI test: app sin formulario de login detectado (herokuapp_CrearUsuario)');
