...
/**
 * Visual regression test for herokuapp_CrearUsuario
 ...
 */
test.describe('Visual regression for herokuapp_CrearUsuario', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('herokuapp_CrearUsuario.png', {
      fullPage: true,
