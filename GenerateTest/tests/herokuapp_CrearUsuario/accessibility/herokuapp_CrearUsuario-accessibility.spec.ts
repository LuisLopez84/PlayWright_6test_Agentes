...
/**
 * Accessibility tests for herokuapp_CrearUsuario
 ...
 */
test.describe('Accessibility tests for herokuapp_CrearUsuario', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for herokuapp_CrearUsuario:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en herokuapp_CrearUsuario`).toBe(0);
