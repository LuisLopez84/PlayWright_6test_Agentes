...
/**
 * Visual regression test for Homebanking_Transf
 ...
 */
test.describe('Visual regression for Homebanking_Transf', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_Transf.png', {
      fullPage: true,
