...
/**
 * Accessibility tests for Homebanking_Transf
 ...
 */
test.describe('Accessibility tests for Homebanking_Transf', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for Homebanking_Transf:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebanking_Transf`).toBe(0);
