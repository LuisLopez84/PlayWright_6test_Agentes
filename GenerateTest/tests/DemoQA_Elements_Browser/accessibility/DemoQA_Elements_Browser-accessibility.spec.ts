...
/**
 * Accessibility tests for DemoQA_Elements_Browser
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Browser', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Browser:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Browser`).toBe(0);
