...
/**
 * Visual regression test for DemoQA_Elements_Browser
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Browser', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Browser.png', {
      fullPage: true,
