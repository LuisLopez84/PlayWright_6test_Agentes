...
/**
 * Visual regression test for DemoQA_Elements_WebTables
 ...
 */
test.describe('Visual regression for DemoQA_Elements_WebTables', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_WebTables.png', {
      fullPage: true,
