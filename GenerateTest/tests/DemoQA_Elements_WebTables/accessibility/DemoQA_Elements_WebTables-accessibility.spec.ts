...
/**
 * Accessibility tests for DemoQA_Elements_WebTables
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_WebTables', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_WebTables:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_WebTables`).toBe(0);
