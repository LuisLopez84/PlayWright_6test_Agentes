...
/**
 * Visual regression test for Homebankink_PagoServicios
 ...
 */
test.describe('Visual regression for Homebankink_PagoServicios', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebankink_PagoServicios.png', {
      fullPage: true,
