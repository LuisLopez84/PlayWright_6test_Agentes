...
/**
 * Visual regression test for DemoQA_Elements_Widges
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Widges', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Widges.png', {
      fullPage: true,
