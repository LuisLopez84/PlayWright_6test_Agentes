...
/**
 * Accessibility tests for DemoQA_Elements_Widges
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Widges', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Widges:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Widges`).toBe(0);
