...
/**
 * Accessibility tests for Homebankink_TarjetaVirtual
 ...
 */
test.describe('Accessibility tests for Homebankink_TarjetaVirtual', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for Homebankink_TarjetaVirtual:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebankink_TarjetaVirtual`).toBe(0);
