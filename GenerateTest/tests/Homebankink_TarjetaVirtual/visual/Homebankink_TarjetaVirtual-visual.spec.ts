...
/**
 * Visual regression test for Homebankink_TarjetaVirtual
 ...
 */
test.describe('Visual regression for Homebankink_TarjetaVirtual', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebankink_TarjetaVirtual.png', {
      fullPage: true,
