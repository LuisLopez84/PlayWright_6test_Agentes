...
/**
 * Visual regression test for DemoQA_Elements_Widges5
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Widges5', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Widges5.png', {
      fullPage: true,
