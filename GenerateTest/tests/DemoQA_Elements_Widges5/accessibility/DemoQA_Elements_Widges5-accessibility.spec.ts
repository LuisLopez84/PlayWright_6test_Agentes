...
/**
 * Accessibility tests for DemoQA_Elements_Widges5
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Widges5', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Widges5:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Widges5`).toBe(0);
