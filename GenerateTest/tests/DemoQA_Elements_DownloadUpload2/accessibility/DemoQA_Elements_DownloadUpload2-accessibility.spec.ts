...
/**
 * Accessibility tests for DemoQA_Elements_DownloadUpload2
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_DownloadUpload2', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_DownloadUpload2:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_DownloadUpload2`).toBe(0);
