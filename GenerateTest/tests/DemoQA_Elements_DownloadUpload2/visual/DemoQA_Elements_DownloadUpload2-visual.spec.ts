...
/**
 * Visual regression test for DemoQA_Elements_DownloadUpload2
 ...
 */
test.describe('Visual regression for DemoQA_Elements_DownloadUpload2', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_DownloadUpload2.png', {
      fullPage: true,
