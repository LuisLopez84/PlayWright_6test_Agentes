...
/**
 * Visual regression test for Homebankink_PlazosFijos
 ...
 */
test.describe('Visual regression for Homebankink_PlazosFijos', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebankink_PlazosFijos.png', {
      fullPage: true,
