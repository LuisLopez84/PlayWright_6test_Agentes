...
/**
 * Accessibility tests for Homebankink_PlazosFijos
 ...
 */
test.describe('Accessibility tests for Homebankink_PlazosFijos', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for Homebankink_PlazosFijos:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebankink_PlazosFijos`).toBe(0);
