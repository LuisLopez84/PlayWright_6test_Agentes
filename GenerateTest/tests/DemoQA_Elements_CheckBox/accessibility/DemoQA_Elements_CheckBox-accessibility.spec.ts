...
/**
 * Accessibility tests for DemoQA_Elements_CheckBox
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_CheckBox', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_CheckBox:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_CheckBox`).toBe(0);
