...
/**
 * Visual regression test for DemoQA_Elements_CheckBox
 ...
 */
test.describe('Visual regression for DemoQA_Elements_CheckBox', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_CheckBox.png', {
      fullPage: true,
