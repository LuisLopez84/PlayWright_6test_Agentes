...
/**
 * Accessibility tests for DemoQA_Elements_TextBox
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_TextBox', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_TextBox:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_TextBox`).toBe(0);
