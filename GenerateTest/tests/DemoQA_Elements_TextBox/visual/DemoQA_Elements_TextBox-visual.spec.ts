...
/**
 * Visual regression test for DemoQA_Elements_TextBox
 ...
 */
test.describe('Visual regression for DemoQA_Elements_TextBox', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_TextBox.png', {
      fullPage: true,
