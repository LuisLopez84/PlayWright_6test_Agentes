...
/**
 * Visual regression test for Homebankink_Prestamos
 ...
 */
test.describe('Visual regression for Homebankink_Prestamos', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebankink_Prestamos.png', {
      fullPage: true,
