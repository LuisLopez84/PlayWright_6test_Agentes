...
/**
 * Accessibility tests for Homebankink_Prestamos
 ...
 */
test.describe('Accessibility tests for Homebankink_Prestamos', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for Homebankink_Prestamos:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebankink_Prestamos`).toBe(0);
