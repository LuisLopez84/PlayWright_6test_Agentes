...
/**
 * Visual regression test for DemoQA_Elements_Interactions
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Interactions', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Interactions.png', {
      fullPage: true,
