...
/**
 * Accessibility tests for DemoQA_Elements_Interactions
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Interactions', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Interactions:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Interactions`).toBe(0);
