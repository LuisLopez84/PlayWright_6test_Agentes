...
/**
 * Accessibility tests for DemoQA_Elements_Widges6
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Widges6', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Widges6:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Widges6`).toBe(0);
