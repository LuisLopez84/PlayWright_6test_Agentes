...
/**
 * Visual regression test for DemoQA_Elements_Widges6
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Widges6', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Widges6.png', {
      fullPage: true,
