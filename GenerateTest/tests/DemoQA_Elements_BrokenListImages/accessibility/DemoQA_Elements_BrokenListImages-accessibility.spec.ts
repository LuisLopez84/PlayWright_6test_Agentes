...
/**
 * Accessibility tests for DemoQA_Elements_BrokenListImages
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_BrokenListImages', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_BrokenListImages:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_BrokenListImages`).toBe(0);
