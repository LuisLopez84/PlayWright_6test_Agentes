...
/**
 * Visual regression test for DemoQA_Elements_BrokenListImages
 ...
 */
test.describe('Visual regression for DemoQA_Elements_BrokenListImages', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_BrokenListImages.png', {
      fullPage: true,
