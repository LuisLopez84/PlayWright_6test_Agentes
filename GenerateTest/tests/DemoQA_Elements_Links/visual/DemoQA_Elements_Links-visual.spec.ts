...
/**
 * Visual regression test for DemoQA_Elements_Links
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Links', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Links.png', {
      fullPage: true,
