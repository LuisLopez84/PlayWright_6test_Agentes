...
/**
 * Accessibility tests for DemoQA_Elements_Links
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Links', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Links:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Links`).toBe(0);
