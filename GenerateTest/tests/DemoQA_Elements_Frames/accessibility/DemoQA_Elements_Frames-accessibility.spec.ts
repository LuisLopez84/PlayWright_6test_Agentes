...
/**
 * Accessibility tests for DemoQA_Elements_Frames
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Frames', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Frames:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Frames`).toBe(0);
