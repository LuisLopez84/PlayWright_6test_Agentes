...
/**
 * Visual regression test for DemoQA_Elements_Frames
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Frames', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Frames.png', {
      fullPage: true,
