...
/**
 * Visual regression test for herokuapp_EditarUsuario
 ...
 */
test.describe('Visual regression for herokuapp_EditarUsuario', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('herokuapp_EditarUsuario.png', {
      fullPage: true,
