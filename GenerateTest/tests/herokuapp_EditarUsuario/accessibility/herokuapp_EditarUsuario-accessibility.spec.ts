...
/**
 * Accessibility tests for herokuapp_EditarUsuario
 ...
 */
test.describe('Accessibility tests for herokuapp_EditarUsuario', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for herokuapp_EditarUsuario:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en herokuapp_EditarUsuario`).toBe(0);
