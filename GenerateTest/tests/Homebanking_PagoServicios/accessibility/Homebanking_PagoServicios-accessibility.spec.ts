...
/**
 * Accessibility tests for Homebanking_PagoServicios
 ...
 */
test.describe('Accessibility tests for Homebanking_PagoServicios', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for Homebanking_PagoServicios:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebanking_PagoServicios`).toBe(0);
