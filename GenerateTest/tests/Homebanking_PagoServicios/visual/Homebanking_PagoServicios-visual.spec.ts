...
/**
 * Visual regression test for Homebanking_PagoServicios
 ...
 */
test.describe('Visual regression for Homebanking_PagoServicios', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_PagoServicios.png', {
      fullPage: true,
