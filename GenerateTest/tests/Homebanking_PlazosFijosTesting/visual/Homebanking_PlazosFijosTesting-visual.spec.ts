...
/**
 * Visual regression — Homebanking_PlazosFijosTesting
...
test.describe('Visual regression: Homebanking_PlazosFijosTesting', () => {
  ...
  test('screenshot — desktop 1280×720', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_PlazosFijosTesting-desktop.png', {
      fullPage:           true,
  ...
  test('screenshot — mobile 375×812', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_PlazosFijosTesting-mobile.png', {
      fullPage:           true,
      maxDiffPixelRatio:  VISUAL_DIFF_RATIO,
      animations:         'disabled',
    });
