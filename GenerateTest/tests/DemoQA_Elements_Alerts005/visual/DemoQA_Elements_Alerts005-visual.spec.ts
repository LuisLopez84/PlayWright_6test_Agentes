...
/**
 * Visual regression test for DemoQA_Elements_Alerts005
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Alerts005', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Alerts005.png', {
      fullPage: true,
