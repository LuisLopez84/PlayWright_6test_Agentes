...
/**
 * Accessibility tests for DemoQA_Elements_Alerts005
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Alerts005', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Alerts005:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Alerts005`).toBe(0);
