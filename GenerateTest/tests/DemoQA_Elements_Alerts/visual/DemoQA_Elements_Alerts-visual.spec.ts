...
/**
 * Visual regression test for DemoQA_Elements_Alerts
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Alerts', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Alerts.png', {
      fullPage: true,
