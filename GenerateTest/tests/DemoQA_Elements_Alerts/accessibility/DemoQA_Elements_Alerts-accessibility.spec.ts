...
/**
 * Accessibility tests for DemoQA_Elements_Alerts
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Alerts', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Alerts:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Alerts`).toBe(0);
