...
/**
 * Visual regression test for DemoQA_Elements_DinamicProperties
 ...
 */
test.describe('Visual regression for DemoQA_Elements_DinamicProperties', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_DinamicProperties.png', {
      fullPage: true,
