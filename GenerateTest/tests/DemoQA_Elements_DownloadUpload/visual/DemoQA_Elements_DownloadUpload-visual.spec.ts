...
/**
 * Visual regression test for DemoQA_Elements_DownloadUpload
 ...
 */
test.describe('Visual regression for DemoQA_Elements_DownloadUpload', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_DownloadUpload.png', {
      fullPage: true,
