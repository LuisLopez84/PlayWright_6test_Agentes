...
/**
 * Accessibility tests for DemoQA_Elements_DownloadUpload
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_DownloadUpload', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_DownloadUpload:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_DownloadUpload`).toBe(0);
