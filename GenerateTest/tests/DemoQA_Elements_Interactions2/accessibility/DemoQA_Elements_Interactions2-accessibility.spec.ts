...
/**
 * Accessibility tests for DemoQA_Elements_Interactions2
 ...
 */
test.describe('Accessibility tests for DemoQA_Elements_Interactions2', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for DemoQA_Elements_Interactions2:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en DemoQA_Elements_Interactions2`).toBe(0);
