...
test.describe('Brute force protection for DemoQA_Elements_Interactions2', () => {
  ...
  test('Protección contra brute force via UI', async ({ page }) => {
    ...
    console.log('ℹ️ Brute force UI test: app sin formulario de login detectado (DemoQA_Elements_Interactions2)');
