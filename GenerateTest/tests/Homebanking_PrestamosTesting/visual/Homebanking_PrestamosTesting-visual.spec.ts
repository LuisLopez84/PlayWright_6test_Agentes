...
/**
 * Visual regression — Homebanking_PrestamosTesting
...
test.describe('Visual regression: Homebanking_PrestamosTesting', () => {
  ...
  test('screenshot — desktop 1280×720', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_PrestamosTesting-desktop.png', {
      fullPage:           true,
  ...
  test('screenshot — mobile 375×812', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_PrestamosTesting-mobile.png', {
      fullPage:           true,
      maxDiffPixelRatio:  VISUAL_DIFF_RATIO,
      animations:         'disabled',
    });
