...
/**
 * Visual regression — Homebanking_Tarjeta_Virtual
...
test.describe('Visual regression: Homebanking_Tarjeta_Virtual', () => {
  ...
  test('screenshot — desktop 1280×720', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_Tarjeta_Virtual-desktop.png', {
      fullPage:           true,
  ...
  test('screenshot — mobile 375×812', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_Tarjeta_Virtual-mobile.png', {
      fullPage:           true,
      maxDiffPixelRatio:  VISUAL_DIFF_RATIO,
      animations:         'disabled',
    });
