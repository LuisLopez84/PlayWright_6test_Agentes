...
/**
 * Visual regression test for DemoQA_Elements_Widges9
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Widges9', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Widges9.png', {
      fullPage: true,
