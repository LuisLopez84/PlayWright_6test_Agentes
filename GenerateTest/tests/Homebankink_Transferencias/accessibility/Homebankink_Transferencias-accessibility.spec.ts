...
/**
 * Accessibility tests for Homebankink_Transferencias
 ...
 */
test.describe('Accessibility tests for Homebankink_Transferencias', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for Homebankink_Transferencias:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebankink_Transferencias`).toBe(0);
