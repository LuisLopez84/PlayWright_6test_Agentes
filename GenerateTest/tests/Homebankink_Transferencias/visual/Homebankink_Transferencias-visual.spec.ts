...
/**
 * Visual regression test for Homebankink_Transferencias
 ...
 */
test.describe('Visual regression for Homebankink_Transferencias', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebankink_Transferencias.png', {
      fullPage: true,
