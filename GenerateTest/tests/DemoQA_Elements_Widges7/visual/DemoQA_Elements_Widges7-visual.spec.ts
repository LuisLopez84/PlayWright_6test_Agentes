...
/**
 * Visual regression test for DemoQA_Elements_Widges7
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Widges7', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Widges7.png', {
      fullPage: true,
