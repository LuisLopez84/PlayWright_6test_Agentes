...
/**
 * Visual regression test for DemoQA_Elements_Browser3
 ...
 */
test.describe('Visual regression for DemoQA_Elements_Browser3', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('DemoQA_Elements_Browser3.png', {
      fullPage: true,
