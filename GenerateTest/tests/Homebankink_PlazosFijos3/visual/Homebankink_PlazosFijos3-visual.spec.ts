...
/**
 * Visual regression test for Homebankink_PlazosFijos3
 ...
 */
test.describe('Visual regression for Homebankink_PlazosFijos3', () => {
  ...
  test('screenshot comparison', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebankink_PlazosFijos3.png', {
      fullPage: true,
