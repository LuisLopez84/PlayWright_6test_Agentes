...
/**
 * Accessibility tests for Homebankink_PlazosFijos3
 ...
 */
test.describe('Accessibility tests for Homebankink_PlazosFijos3', () => {
  ...
  test('axe scan — sin violaciones críticas', async ({ page }) => {
    ...
    console.log(`♿ Accessibility scan for Homebankink_PlazosFijos3:`);
    ...
    // expect(critical.length, `${critical.length} violaciones críticas en Homebankink_PlazosFijos3`).toBe(0);
