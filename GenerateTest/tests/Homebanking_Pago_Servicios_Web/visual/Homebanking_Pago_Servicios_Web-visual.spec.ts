...
/**
 * Visual regression — Homebanking_Pago_Servicios_Web
...
test.describe('Visual regression: Homebanking_Pago_Servicios_Web', () => {
  ...
  test('screenshot — desktop 1280×720', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_Pago_Servicios_Web-desktop.png', {
      fullPage:           true,
  ...
  test('screenshot — mobile 375×812', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('Homebanking_Pago_Servicios_Web-mobile.png', {
      fullPage:           true,
      maxDiffPixelRatio:  VISUAL_DIFF_RATIO,
      animations:         'disabled',
    });
