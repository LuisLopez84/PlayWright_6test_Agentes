// Generated from: GenerateTest\features\DemoQA_Elements_Browser3.feature
import { test } from "playwright-bdd";

test.describe('DemoQA_Elements_Browser3', () => {

  test('Flujo DemoQA_Elements_Browser3', { tag: ['@UI'] }, async ({ Given, Then, And, page }) => { 
    ...
    await And('hace clic en "New Window Message"', null, { page }); 
    await And('hace clic en "Knowledge increases by"', null, { page }); 
