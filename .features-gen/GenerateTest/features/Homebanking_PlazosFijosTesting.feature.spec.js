// Generated from: GenerateTest\features\Homebanking_PlazosFijosTesting.feature
import { test } from "playwright-bdd";

test.describe('Homebanking_PlazosFijosTesting', () => {

  test('Flujo Homebanking_PlazosFijosTesting', async ({ Given, When, Then, And, page }) => { 
    ...
    await And('completa "Monto a invertir" con "1100"', null, { page }); 
