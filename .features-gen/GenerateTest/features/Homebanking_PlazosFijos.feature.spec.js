...
test.describe('Homebanking_PlazosFijos', () => {
  ...
  test('Flujo Homebanking_PlazosFijos', async ({ Given, When, Then, And, page }) => { 
    ...
    await And('la página está disponible sin errores', null, { page }); 
    ...
    await And('completa "Monto a invertir" con "2222"', null, { page }); 
