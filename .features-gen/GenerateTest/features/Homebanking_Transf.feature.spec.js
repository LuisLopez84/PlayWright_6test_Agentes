// Generated from: GenerateTest\features\Homebanking_Transf.feature
import { test } from "playwright-bdd";

test.describe('Homebanking_Transf', () => {

  test('Flujo Homebanking_Transf', { tag: ['@UI'] }, async ({ Given, When, Then, And, page }) => { 
    ...
    await And('completa "Monto" con "1003"', null, { page }); 
    await And('hace clic en "Descripción (opcional)"', null, { page }); 
    await And('completa "Descripción (opcional)" con "cloud 002"', null, { page }); 
