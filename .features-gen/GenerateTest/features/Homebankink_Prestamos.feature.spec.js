// Generated from: GenerateTest\features\Homebankink_Prestamos.feature
import { test } from "playwright-bdd";

test.describe('Homebankink_Prestamos', () => {

  test('Flujo Homebankink_Prestamos', { tag: ['@UI'] }, async ({ Given, When, Then, And, page }) => { 
    ...
    await And('hace clic en "Monto a solicitar"', null, { page }); 
    await And('completa "Monto a solicitar" con "2500"', null, { page }); 
