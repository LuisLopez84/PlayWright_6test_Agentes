// Generated from: GenerateTest\features\Servicio_Operacion_REST_GET_003_api.feature
import { test } from "playwright-bdd";

test.describe('API REST GET - Servicio Operacion REST GET 003', () => {

  test.beforeEach('Background', async ({ Given }, testInfo) => { if (testInfo.error) return;
    await Given('el servicio REST "GET" "https://homebanking-demo.onrender.com/transacciones/?limit=10" está configurado para pruebas API'); 
  });
  
  test('Servicio Operacion REST GET 003 - Petición exitosa', async ({ When, Then, request }) => { 
    await When('ejecuto la petición API configurada', null, { request }); 
    await Then('la respuesta debe tener un estado de éxito 2xx'); 
  });

  test('Servicio Operacion REST GET 003 - Error técnico del servidor', async ({ When, Then, request }) => { 
  ...
  test('Servicio Operacion REST GET 003 - Error por datos inválidos', async ({ When, Then, request }) => { 
