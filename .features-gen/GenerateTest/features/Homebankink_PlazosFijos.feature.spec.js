// Generated from: GenerateTest\features\Homebankink_PlazosFijos.feature
import { test } from "playwright-bdd";

test.describe('Homebankink_PlazosFijos', () => {

  test('Flujo Homebankink_PlazosFijos', { tag: ['@UI'] }, async ({ Given, When, Then, And, page }) => { 
    ...
    await And('completa "Monto a invertir" con "2000"', null, { page }); 
