// Generated from: GenerateTest\features\DemoQA_Elements_RadioButton.feature
import { test } from "playwright-bdd";

test.describe('DemoQA_Elements_RadioButton', () => {

  test('Flujo DemoQA_Elements_RadioButton', { tag: ['@UI'] }, async ({ Given, Then, And, page }) => { 
    ...
    await And('hace clic en "Radio Button"', null, { page }); 
