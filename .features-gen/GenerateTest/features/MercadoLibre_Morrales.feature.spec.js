...
test.describe('MercadoLibre_Morrales', () => {
  ...
  test('Flujo MercadoLibre_Morrales', async ({ Given, When, Then, And, page }) => { 
    ...
    await And('hace clic en "morrales hombre"', null, { page }); 
    await When('el usuario ingresa "pruebas@pruebas.com.co" en "user_id"', null, { page }); 
