// Generated from: GenerateTest\features\DemoQA_Elements_Browser.feature
import { test } from "playwright-bdd";

test.describe('DemoQA_Elements_Browser', () => {

  test('Flujo DemoQA_Elements_Browser', { tag: ['@UI'] }, async ({ Given, Then, And, page }) => { 
    ...
    await And('hace clic en "New Tab"', null, { page }); 
