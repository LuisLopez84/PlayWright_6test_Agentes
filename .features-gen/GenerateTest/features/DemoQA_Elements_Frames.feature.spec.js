// Generated from: GenerateTest\features\DemoQA_Elements_Frames.feature
import { test } from "playwright-bdd";

test.describe('DemoQA_Elements_Frames', () => {

  test('Flujo DemoQA_Elements_Frames', { tag: ['@UI'] }, async ({ Given, Then, And, page }) => { 
    ...
    await And('hace clic en "Frames"', null, { page }); 
