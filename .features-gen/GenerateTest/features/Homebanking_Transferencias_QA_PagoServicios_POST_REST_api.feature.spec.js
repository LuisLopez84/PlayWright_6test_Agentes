// Generated from: GenerateTest\features\Homebanking_Transferencias_QA_PagoServicios_POST_REST_api.feature
import { test } from "playwright-bdd";

test.describe('API REST POST - Homebanking Transferencias QA PagoServicios POST REST', () => {
  ...
  test('Homebanking Transferencias QA PagoServicios POST REST - Petición exitosa', async ({ When, Then, request }) => { 
    await When('ejecuto la petición API configurada', null, { request }); 
    await Then('la respuesta debe tener un estado de éxito 2xx'); 
  });

  test('Homebanking Transferencias QA PagoServicios POST REST - Error técnico del servidor', async ({ When, Then, request }) => { 
  ...
  test('Homebanking Transferencias QA PagoServicios POST REST - Error por datos inválidos', async ({ When, Then, request }) => { 
...
test.use({
  ...
  $uri: [({}, use) => use('GenerateTest\\features\\Homebanking_Transferencias_QA_PagoServicios_POST_REST_api.feature'), { scope: 'test', box: true }],
