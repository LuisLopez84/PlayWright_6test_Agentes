// Generated from: GenerateTest\features\Homebanking_Pruebas002.feature
import { test } from "playwright-bdd";

test.describe('Homebanking_Pruebas002', () => {

  test('Flujo Homebanking_Pruebas002', async ({ Given, When, Then, And, page }) => { 
    ...
    await And('completa "Monto a invertir" con "1003"', null, { page }); 
    await And('hace clic en "Crear Plazo Fijo"', null, { page }); 
    await And('hace clic en "Confirmar"', null, { page }); 
    await And('hace clic en "Plazo fijo creado exitosamente"', null, { page }); 
