// Generated from: GenerateTest\features\Homebanking_TransferenciasTesting_POST_REST_api.feature
import { test } from "playwright-bdd";

test.describe('API REST POST - Homebanking TransferenciasTesting POST REST', () => {

  test.beforeEach('Background', async ({ Given }, testInfo) => { if (testInfo.error) return;
    await Given('el servicio REST "POST" "https://homebanking-demo.onrender.com/transferencias/" está configurado para pruebas API'); 
  });
  
  test('Homebanking TransferenciasTesting POST REST - Petición exitosa', async ({ When, Then, request }) => { 
    await When('ejecuto la petición API configurada', null, { request }); 
    await Then('la respuesta debe tener un estado de éxito 2xx'); 
  });

  test('Homebanking TransferenciasTesting POST REST - Error técnico del servidor', async ({ When, Then, request }) => { 
  ...
  test('Homebanking TransferenciasTesting POST REST - Error por datos inválidos', async ({ When, Then, request }) => { 
